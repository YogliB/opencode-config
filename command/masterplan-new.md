...
| --- | ----------- | -------------- | ----------- | ------------------------------ |
| PR0 | [repo-name] | ⏸️ Not Started | -           | [description] - blocked by [X] |
| PR1 | [repo-name] | 🟡 In Progress | [PR#N](url) | [description]                  |
| PR2 | [repo-name] | 🟢 Completed   | [PR#N](url) | [description]                  |
```
...
### Stage 0: [Optional - Feature Flag / Pre-deployment]

[If feature flags are used, describe deployment here]
