...
All memory bank files MUST:

- Use the `.mdc` extension.
- Include frontmatter with a clear `description` and `alwaysApply: false`.

Example frontmatter:

```md
---
description: Short, specific purpose of this memory bank file
alwaysApply: false
---
```
